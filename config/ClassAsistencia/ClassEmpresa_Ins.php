...
if ($_POST != "" ){
  try{
    ...
    $query = "INSERT INTO gloriadiaz.tba_regist_empresa 
                         (cedula, nom_comple, telefono, correo, dir_reside, localida, lugar_votacio, usuario, activo, fec_creaci, fec_modifi, empresa, organizador ) 
                  VALUES ('$num_cedula', '$nombre', '$telefono', '$email', '$direccion', '$localidad', '$lugar_votacio', '$usuario', 'Y', '$hoy', '$hoy', '$organizador', '$empresa')";
