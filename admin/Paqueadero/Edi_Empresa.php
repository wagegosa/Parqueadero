...
if(!empty($_SESSION['active'])){
  ...
  try {
    $query="SELECT * FROM gloriadiaz.tba_regist_empresa WHERE idtba_regist_asiste = ".$_GET['id'];
  ...
  <body>
    <div class="container">
      ...
      <!-- Formulario -->
      <form method="post" autocomplete="on" id="frm" action="../../config/ClassAsistencia/ClassEmpresa_upd.php?c=<?=$_GET['id'];?>">
        <!-- Cedula -->
        <div class="row">
        ...
        <!-- EMPRESA -->
          <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-10 col-lg-10">
              <input type="text" class="form-control" name="empresa" id="empresa" placeholder="Empresa" value="<?=$R['empresa'];?>">
              <span class="help-block" id="error"></span>
            </div>
          </div>
        <div><br>
