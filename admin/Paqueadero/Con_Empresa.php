...
?>
  ...
  <body>
    <div class="container">
      ...
      <?php if($_GET != null){?>
      <div class="alert alert-success">Se <strong>Actualizarón</strong> los datos corrrectamente</div>
      <?php } ?>
      <div class="row">
        <div class="col-md-12">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="index.php">Asistentes</a></li>
           ...
           <table class="table table-bordered  table-hover table-striped" id="myTable" width="100%" name="myTable">
            <thead>
              <tr>
                ...
                <th data-breakpoints="xs sm">Asitente</th>
                <th data-breakpoints="xs sm">Usuario</th>
                <th data-breakpoints="xs sm">Empresa</th>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><?= $libro->empresa; ?></td>
                <td>
                  <a href="Edi_Empresa.php?id=<?= $libro->idtba_regist_asiste;?>" class="btn btn-primary btn-primary"><span class="glyphicon glyphicon-pencil"></span></a>
                </td>
              </tr>
              <?php endforeach ?>
            </tbody>
