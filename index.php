...
if(!empty($_SESSION['active'])){
  ...
  if(!empty($_POST)){
    if(empty($_POST['username']) || empty($_POST['pass'])){
      ...
      // $pass = md5($_POST['pass']);
      $pass = $_POST['pass'];
      $query = "SELECT id, perfil, usuario, nom_comple FROM parqueadero.usuarios WHERE usuario = '$user' AND pass = '$pass'  AND activo = 'Y'";
...
<body>
  <div class="limiter">
    <div class="container-login100" style="background-image: url('img/gloriadiaz.jpeg');">
      <div class="wrap-login100 p-t-190 p-b-30">
        <form method="post" autocomplete="on" id="frm" action="">
          <div class="login100-form-avatar">
            <img src="img/gloriadiaz.jpeg" alt="AVATAR">
          </div>
